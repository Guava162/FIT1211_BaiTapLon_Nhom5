...
int main() {
    ...
    do {
        ...
        cout << "2. Sua thong tin san pham (theo ma)\n";
        cout << "3. Xoa san pham\n";
        cout << "4. Nhap thong tin don hang\n";
        cout << "5. Sua thong tin don hang (theo ma)\n";
        cout << "6. Xoa don hang (theo ma)\n";
        cout << "7. Liet ke toan bo san pham trong he thong\n";
        cout << "8. Liet ke toan bo don hang co trong he thong\n";
        cout << "9. Thoat khoi he thong\n";
        cout << "========================================\n";
        ...
        switch (choice) {
            ...
            case 5: suaThongTinHoaDon(dsHDX, nHDX, kho, nKho); break;
